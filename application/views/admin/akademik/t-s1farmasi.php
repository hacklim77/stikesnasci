            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">SI Farmasi</li>
                  </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="row">  
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input name="nama_program_studi" id="nama_program_studi" value="<?php print_r($prodi[4]) ?>" class="form-control" accept-charset="character_set" readonly>
                    </div>
                    <div class="form-group">
